...
class UnexpectedErrorLogRegressionTest extends SystemAdminRegressionSupport {
    ...
    void unexpectedErrorKeepsTypeAndUriWithoutLoggingTheException() throws Exception {
        ...
        assertThat(adminDisplayNameInDatabase())
        ...
        assertThat(loggedText(appender))
                ...
                .doesNotContain(ADMIN_DISPLAY)
                .doesNotContain(ADMIN_UNIT_NAME)
                .doesNotContain(adminPasswordHashInDatabase());
    ...
    void theStackIncludingTheDatabaseValueIsOnlyPrintedAtDebugLevel() throws Exception {
        ...
        assertThat(errorEvent.getThrowableProxy())
                ...
                .isNull();
        assertThat(errorEvent.getFormattedMessage()).doesNotContain(ADMIN_DISPLAY);
    }
    ...
    private String adminDisplayNameInDatabase() {
        return jdbcTemplate.queryForObject(
                "SELECT display_name FROM sys_user WHERE login_name = ?",
                String.class, ADMIN_LOGIN);
    }

    private String adminPasswordHashInDatabase() {
        return jdbcTemplate.queryForObject(
