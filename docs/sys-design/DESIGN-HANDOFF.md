# 7c06e1e2-8033-47bb-803c-9ac03b2994f8 implementation handoff
...
- `design-system.html`
- `index.html`
- `p01-graph-workbench.html`
- `p02-ai-workbench.html`
- `p03-data-tasks.html`
- `p04-user-management.html`
- `p05-intel-collaboration.html`
- `p05b-intel-receiving.html`
